...
public class Endmarker extends Annotation {
  ...
  public final static String _TypeName = "org.texttechnologylab.annotation.sentence.Endmarker";
  ...
  private final static CallSite _FC_value = TypeSystemImpl.createCallSite(Endmarker.class, "value");
   ...
   */
  public Endmarker(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
