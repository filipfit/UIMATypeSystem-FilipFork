 ...
 * @generated */
public class Infront extends OrientationEdge {
 
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static String _TypeName = "org.texttechnologylab.annotation.orientation.type.Infront";
  
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Infront.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  ...
  protected Infront() {/* intentionally empty block */}
   ...
   */
  public Infront(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
