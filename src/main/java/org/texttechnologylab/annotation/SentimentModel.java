...
public class SentimentModel extends SentimentBert {
  ...
  public final static String _TypeName = "org.texttechnologylab.annotation.SentimentModel";
  ...
  private final static CallSite _FC_model = TypeSystemImpl.createCallSite(SentimentModel.class, "model");
   ...
   */
  public SentimentModel(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
