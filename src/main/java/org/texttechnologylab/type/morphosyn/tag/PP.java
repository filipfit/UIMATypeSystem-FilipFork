 ...
 * @generated */
public class PP extends MorphosynTag {
 
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static String _TypeName = "org.texttechnologylab.type.morphosyn.tag.PP";
   ...
   */
  public PP(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
