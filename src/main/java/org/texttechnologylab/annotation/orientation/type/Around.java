 ...
 * @generated */
public class Around extends OrientationEdge {
 
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static String _TypeName = "org.texttechnologylab.annotation.orientation.type.Around";
  
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Around.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  ...
  protected Around() {/* intentionally empty block */}
   ...
   */
  public Around(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
