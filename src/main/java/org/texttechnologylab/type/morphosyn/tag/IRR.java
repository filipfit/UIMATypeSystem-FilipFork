...
public class IRR extends MorphosynTag {
  ...
  public final static String _TypeName = "org.texttechnologylab.type.morphosyn.tag.IRR";
  
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(IRR.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  ...
  protected IRR() {/* intentionally empty block */}
   ...
   */
  public IRR(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
  ...
  */  
  public IRR(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
