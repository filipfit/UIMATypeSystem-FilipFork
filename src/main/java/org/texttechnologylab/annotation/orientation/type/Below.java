 ...
 * @generated */
public class Below extends OrientationEdge {
 
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static String _TypeName = "org.texttechnologylab.annotation.orientation.type.Below";
  
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Below.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  ...
  protected Below() {/* intentionally empty block */}
   ...
   */
  public Below(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
