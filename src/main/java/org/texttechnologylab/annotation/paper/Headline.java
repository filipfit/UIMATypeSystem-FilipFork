 ...
 * @generated */
public class Headline extends NonTextContent {
 
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static String _TypeName = "org.texttechnologylab.annotation.paper.Headline";
   ...
   */
  public Headline(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
