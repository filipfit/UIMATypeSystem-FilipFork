 ...
 * @generated */
public class NEG extends MorphosynTag {
 
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static String _TypeName = "org.texttechnologylab.type.morphosyn.tag.NEG";
   ...
   */
  public NEG(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
