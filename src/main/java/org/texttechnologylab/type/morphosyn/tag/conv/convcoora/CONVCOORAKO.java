...
package org.texttechnologylab.type.morphosyn.tag.conv.convcoora;
...
import org.texttechnologylab.type.morphosyn.tag.conv.CONVCOORA;
...
public class CONVCOORAKO extends CONVCOORA {
  ...
  public final static String _TypeName = "org.texttechnologylab.type.morphosyn.tag.conv.convcoora.CONVCOORAKO";
   ...
   */
  public CONVCOORAKO(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
