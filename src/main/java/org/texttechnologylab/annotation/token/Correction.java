...
public class Correction extends Annotation {
  ...
  public final static String _TypeName = "org.texttechnologylab.annotation.token.Correction";
  ...
  private final static CallSite _FC_value = TypeSystemImpl.createCallSite(Correction.class, "value");
   ...
   */
  public Correction(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
