...
public class NMZIRRKO extends NMZIRR {
  ...
  public final static String _TypeName = "org.texttechnologylab.type.morphosyn.tag.nmz.nmzirr.NMZIRRKO";
  
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(NMZIRRKO.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  ...
  protected NMZIRRKO() {/* intentionally empty block */}
   ...
   */
  public NMZIRRKO(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
  ...
  */  
  public NMZIRRKO(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
