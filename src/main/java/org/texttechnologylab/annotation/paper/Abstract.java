 ...
 * @generated */
public class Abstract extends TextContent {
 
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static String _TypeName = "org.texttechnologylab.annotation.paper.Abstract";
   ...
   */
  public Abstract(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
