...
public class NonMotionEvent extends Event {
   ...
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(NonMotionEvent.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   */
  public NonMotionEvent(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public NonMotionEvent(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
