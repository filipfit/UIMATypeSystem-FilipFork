...
public class Possession_Property extends AbstractNamedEntity {
  ...
  public final static String _TypeName = "org.texttechnologylab.annotation.type.concept.Possession_Property";
   ...
   */
  public Possession_Property(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
