...
package org.texttechnologylab.type.morphosyn.tag.conv.convneg;
...
import org.texttechnologylab.type.morphosyn.tag.conv.CONVNEG;
...
public class CONVNEGJA extends CONVNEG {
  ...
  public final static String _TypeName = "org.texttechnologylab.type.morphosyn.tag.conv.convneg.CONVNEGJA";
   ...
   */
  public CONVNEGJA(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
