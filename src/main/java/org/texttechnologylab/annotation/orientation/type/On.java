 ...
 * @generated */
public class On extends OrientationEdge {
 
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static String _TypeName = "org.texttechnologylab.annotation.orientation.type.On";
  
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(On.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  ...
  protected On() {/* intentionally empty block */}
   ...
   */
  public On(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
