 ...
 * @generated */
public class TOP extends MorphosynTag {
 
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static String _TypeName = "org.texttechnologylab.type.morphosyn.tag.TOP";
  ...
  protected TOP() {/* intentionally empty block */}
   ...
   */
  public TOP(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
  ...
  */  
  public TOP(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
