...
package org.texttechnologylab.type.morphosyn.tag.conv.convpurp1;
...
import org.texttechnologylab.type.morphosyn.tag.conv.CONVPURP1;
...
public class CONVPURP1KO extends CONVPURP1 {
  ...
  public final static String _TypeName = "org.texttechnologylab.type.morphosyn.tag.conv.convpurp1.CONVPURP1KO";
   ...
   */
  public CONVPURP1KO(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
