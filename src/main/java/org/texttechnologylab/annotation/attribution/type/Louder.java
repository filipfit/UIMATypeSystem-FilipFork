...
public class Louder extends Attribution {
  ...
  public final static String _TypeName = "org.texttechnologylab.annotation.attribution.type.Louder";
  
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Louder.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  ...
  protected Louder() {/* intentionally empty block */}
   ...
   */
  public Louder(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
