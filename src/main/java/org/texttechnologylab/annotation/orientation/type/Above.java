 ...
 * @generated */
public class Above extends OrientationEdge {
 
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static String _TypeName = "org.texttechnologylab.annotation.orientation.type.Above";
  
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Above.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  ...
  protected Above() {/* intentionally empty block */}
   ...
   */
  public Above(TypeImpl type, CASImpl casImpl) {
    super(type, casImpl);
    readObject();
  }
